...
- [ ] Полный UI audit report: что плохо, где, почему (desktop/tablet/mobile)
- [ ] UI design contract: зафиксированные правила (spacing scale, типошкала, цвета, состояния, компоненты)
